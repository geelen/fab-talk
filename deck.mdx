...
* (In a former life) Java/transport modelling/distributed systems
* (Then, for a while) Rails & devops
* Frontend exclusively for 5+ years (most recently React)
* Co-created CSS Modules & Styled Components
* Co-founder of Linc with Erwin Van der Koogh
...
## _Fit for purpose_ <br/>&<br/>_open_
